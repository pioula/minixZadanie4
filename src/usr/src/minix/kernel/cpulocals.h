...
DECLARE_CPULOCAL(struct proc *, run_b_head[NR_BUCKETS]); /* ptrs to ready bucket headers */
DECLARE_CPULOCAL(struct proc *, run_b_tail[NR_BUCKETS]); /* ptrs to ready bucket tails */
DECLARE_CPULOCAL(int, current_bucket); /* a ptr to current bucket */
